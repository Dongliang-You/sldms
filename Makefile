...
sldms-64:main.c ${LIBOBJ_64}
	$(CC) -o $@ main.c ${LIBOBJ_64} $(CFLAGS) $(LDFLAGS) $(CCLIB) -DM64=1

run:${TARGETS}
	./sldms $(DIR)$(INPUT) -v --sa
	./sldms-64 $(DIR)$(INPUT) -v --sa
...
valgrind:
	valgrind -q --tool=memcheck --leak-check=full --track-origins=yes --show-leak-kinds=all ./sldms $(DIR)$(INPUT) --sa -d 100
